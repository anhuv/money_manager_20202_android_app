package vn.vietanh.quanlychitieu.fragment;
...
import vn.vietanh.quanlychitieu.numberformat.NumberTextWatcherForThousand;
import vn.vietanh.quanlychitieu.R;
import vn.vietanh.quanlychitieu.adapter.ChiTieuAdapter;
import vn.vietanh.quanlychitieu.adapter.LoaiChiSpnAdapter;
import vn.vietanh.quanlychitieu.dao.ChiTieuDAO;
import vn.vietanh.quanlychitieu.dao.LoaiChiDAO;
import vn.vietanh.quanlychitieu.model.ChiTieu;
import vn.vietanh.quanlychitieu.model.LoaiChi;
...
public class TimChiTieuFragment extends Fragment {
    ...
    public void getLoaiChi(){
        ...
        loaiChiList.add(new LoaiChi("Tất cả",R.mipmap.ic_launcher));
